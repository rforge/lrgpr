...
#' wald( fit, terms=2:3)
#' @export
lrgpr <- function( formula, decomp, delta=NULL, nthreads=detectCores(logical=T), W_til=NULL){
...
#'
#' @export
lrgprApply <- function( formula, features, decomp, terms, W_til=NULL, delta=NULL, reEstimateDelta=FALSE, nthreads=detectCores(logical = TRUE)){
...
#'
#' 'convertToBinary' converts TPED and DOSAGE files to binary format
#'
#' @param filename file to be converted
#' @param filenameOut name of binary file produced
#' @param format specify "TPED" or "DOSAGE"
#' @export
